            ...
            <el-form  :model="addForm" :rules="addFormRules" ref="addFormRef"
             label-width="80px" label-position="top">
                <el-tabs v-model="activeIndex" :tab-position="'left'"
                 :before-leave="beforeTabLeave"  @tab-click="tabClikced">
                    ...
                    <el-tab-pane label="商品内容" name="4">
                        <!--富文本编辑器  -->
                        <quill-editor v-model="addForm.goods_introducte"></quill-editor>
...
export default {
    ...
    methods:{
        ...
        beforeTabLeave(aciveName,oldAciveName){
            // console.log('即将离开的标签名字是：'+oldAciveName);
            //  console.log('即将进入的标签名字是：'+AciveName);
